...
public class OrderServiceImpl implements OrderService {
    ...
    public Order completeOrder(Long userId) {
        ...
        logger.info("completeOrder method was called for userId: "
                + "{}", userId);
    ...
    private List<Product> getAllProductsFromShoppingCart(Long userId) {
        ...
        logger.info("Method getAllProductsFromShoppingCart successfully "
                + "retrieved data from DB for userId = {}", userId);
        return products;
    }
}
